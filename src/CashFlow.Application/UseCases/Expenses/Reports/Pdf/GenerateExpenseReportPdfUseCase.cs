...
public class GenerateExpenseReportPdfUseCase : IGenerateExpenseReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        foreach(var expense in expenses)
        {
            ...
            SetStyleBaseForExepenseInformation(row.Cells[0]);
            row.Cells[0].Format.LeftIndent = 20;

            row.Cells[1].AddParagraph(expense.Date.ToString("t"));
            SetStyleBaseForExepenseInformation(row.Cells[1]);

            row.Cells[2].AddParagraph(expense.PaymentType.PaymentTypeToString());
            SetStyleBaseForExepenseInformation(row.Cells[2]);
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Henrique Lima";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph("Hey Henrique Lima");
    ...
    private void SetStyleBaseForExepenseInformation(Cell cell)
    {
